...
const defaultLocales = {
  uz: {
    ...
    invalidName: "❌ Iltimos, ism familiyangizni to'g'ri kiriting.\n_Faqat harflar, kamida 3 ta belgi._",
    invalidDestination: "❌ Iltimos, yo'nalishni to'g'ri kiriting.\n_Masalan: Dubay, Arabiston_",
    invalidDate: "❌ Iltimos, sanani to'g'ri kiriting.\n_Masalan: 19-avgust yoki 20.08.2026_",
    invalidPeople: "❌ Iltimos, odam sonini son ko'rinishida kiriting.\n_Masalan: 2 yoki 5_",
    invalidChildrenCount: "❌ Iltimos, bolalar sonini son ko'rinishida kiriting.\n_Masalan: 1, 2, 3_",
  ...
  ru: {
    ...
    invalidName: "❌ Пожалуйста, введите имя и фамилию правильно.\n_Только буквы, минимум 3 символа._",
    invalidDestination: "❌ Пожалуйста, введите направление правильно.\n_Например: Дубай, Аравия_",
    invalidDate: "❌ Пожалуйста, введите дату правильно.\n_Например: 19 августа или 20.08.2026_",
    invalidPeople: "❌ Введите количество человек цифрой.\n_Например: 2 или 5_",
    invalidChildrenCount: "❌ Введите количество детей цифрой.\n_Например: 1, 2, 3_",
